...
{ 	
 	...
 	GPIO_InitTypeDef Oled = {0};
 	
 	__HAL_RCC_GPIOA_CLK_ENABLE();	
	
  Oled.Pin = OLED_CLK_PIN|OLED_DIN_PIN;	
 	Oled.Mode = GPIO_MODE_OUTPUT_PP; 		
	Oled.Pull = GPIO_NOPULL;
	Oled.Speed = GPIO_SPEED_FREQ_HIGH;
 	HAL_GPIO_Init(OLED_GPIO, &Oled);	  
	
  HAL_GPIO_WritePin(OLED_GPIO,OLED_CLK_PIN|OLED_DIN_PIN,GPIO_PIN_SET);	
	HAL_Delay(200);
